...
pub const fn avail_offset(slots: u16) -> usize { slots as usize * 16 }
...
mod tests {
    ...
    #[test] fn reject_invalid_device_sizes() {
        for slots in [0,3,255,1023,1025,2048,u16::MAX] { assert!(!valid_queue_size(slots)); }
    }
}
